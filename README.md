...
All pots are 100k linear. There's one through-hole resistor used to set the input attenuation into the PT2399. I haven't settled on the perfect value for this yet, hence leaving it t-h to allow testing. Likely the best value is 33k or 47k. (Update: i settled on 33k, 47k seemed to risk pushing it into clipping)
